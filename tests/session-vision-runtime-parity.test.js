...
import * as sessionState from '../lib/session-vision-state.js'
...
test('state-store construction is ownership-pure and exposes no process-global current store', () => {
  assert.equal('currentSessionVisionStateStore' in sessionState, false)
