...
// Measurement age is provenance only. Auto eligibility is invalidated by the
// exact backend identity / benchmark-suite contract, not by wall-clock age.
// Keep the legacy exported age bound effectively unbounded so older callers
// cannot silently reintroduce a seven-day capability TTL.
export const AUTO_MEASURED_MAX_AGE_MS = Number.MAX_SAFE_INTEGER
