  ...
  const newRender = `      var pages=[
      ...
      return h('div',{className:'vr-settings-ia-root','data-vr-settings-ia':'1','data-vr-dirty':dirty?'1':'0','data-vr-invalid':valid?'0':'1'},
        h('div',{className:'vr-ia-page-head'},
          ...
          h('button',{type:'button',className:'vr-btn vr-ia-guide-button',disabled:typeof helpers.startVisionSettingsGuide!=='function',onClick:function(){setPage('');if(typeof helpers.startVisionSettingsGuide==='function')helpers.startVisionSettingsGuide();}},tx('重新查看新手引导','Show beginner guide again'))
        ),
