            ...
            h('div', { className: 'vr-field' },
              ...
              h('div', { className: 'vr-quickstart-actions' },
                ...
                dirty
                  ...
                  : null,
                saveState.status === 'saved' ? h('span', { className: 'vr-hint' }, t('saved')) : null,
                saveState.status === 'error' ? h('span', { className: 'vr-failed' }, String(saveState.error || t('saveFailed'))) : null
              )
            )
          )
        )
