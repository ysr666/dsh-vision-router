 ...
 * visual chains off the global patch. With no plugin proxy configured, DSH/Host
 * owns egress completely; the legacy seam is active only for an explicit Vision
 * Router proxy override combined with a Host-owned/raw-fetch visual provider.
 */
