...
/**
 * Dedicated Connection RPC channel. The DSH carrier supplies Host/Origin/DNS-
 * rebinding protection via trusted-host; it is not authentication. Therefore the
 * channel is additionally opt-in and capability-limited to the safe preference
 * allow-list above. Host/network/privacy/credential-bearing settings remain loopback-only.
 *
 * The independent loopback-only bootstrap permission bridge is installed on
 * full Cordis Host contexts and is intentionally absent from tiny test facades.
 */
