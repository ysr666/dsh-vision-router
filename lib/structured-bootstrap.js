...
export function structuredBootstrapQuestion() {
  return (
    ...
    '"recommended_followups":[{"tool":"vision_describe|vision_ground|vision_detect|vision_crop|vision_ocr|vision_colors|vision_pixel_diff|vision_long_screenshot_ocr","target":"<specific region/object/text>","reason":"<why this follow-up adds evidence>"}]}. ' +
    ...
    'Recommend at least one concrete follow-up evidence call. vision_crop is appropriate when an uncertain or dense region needs enlargement. ' +
    'Do NOT recommend vision_ocr merely because text is visible: use OCR only when exact verbatim transcription is genuinely uncertain or would materially add evidence; for UI/screenshots prefer vision_detect or a focused vision_describe when semantic verification is enough. ' +
