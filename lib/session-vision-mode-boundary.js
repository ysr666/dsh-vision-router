...
export function installSessionVisionModeBoundary(ctx, config = {}) {
  ...
  // assembly. Clear the previous completed-step snapshot before resolving the
  // new activity; otherwise a direct tool dispatch between turns could inherit
  // stale ON authority after the composer has already switched OFF.
  try {
