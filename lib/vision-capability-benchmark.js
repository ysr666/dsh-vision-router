...
const FIXTURES = Object.freeze({
  ...
  grounding: {
    ...
    prompt: 'Locate the SAVE button. Return only [[xmin,ymin,xmax,ymax]] for the tight button rectangle. Normalize x by image width and y by image height, then scale every coordinate to the 0-1000 range. Do not add prose.',
