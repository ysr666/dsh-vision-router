...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const zh = {
      ...
      groupProxy: '网络',
      proxyLabel: '代理地址',
      proxyHint: '如 http://127.0.0.1:10808 或 socks5://127.0.0.1:10808；兼容旧配置 socks5h://。留空关闭。修改即时生效。',
    ...
    const en = {
      ...
      proxyHint: 'e.g. http://127.0.0.1:10808 or socks5://127.0.0.1:10808; legacy socks5h:// values are also supported. Empty disables. Applies immediately.',
