export const SETTINGS_NUMBER_META = Object.freeze({
  timeoutMs: Object.freeze({ min: 1000, max: 600000, step: 1000 }),
  visionTaskTimeoutMs: Object.freeze({ min: 1000, max: 180000, step: 1000 }),
  ocrTimeoutMs: Object.freeze({ min: 1000, max: 120000, step: 1000 }),
  downscaleMaxPixels: Object.freeze({ min: 1000, max: 100000000, step: 1000 }),
