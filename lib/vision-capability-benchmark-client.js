...
export const CAPABILITY_BENCHMARK_CLIENT = String.raw`(function(){
  ...
  function appendMeasuredDetails(container, measured){
    ...
    var meta=css(document.createElement('div'),{fontSize:'12px',opacity:'0.66',marginTop:'4px'}); meta.textContent=text('测评时间仅作记录，不会因时间经过自动失效。','Measurement time is informational and does not expire capability by age.'); card.appendChild(meta);
    ...
    var headers=[text('能力','Capability'),text('分数','Score'),text('中位延迟','Median'),text('测评时间','Measured')];
