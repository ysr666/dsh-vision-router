...
/**
 * Schedule one bounded post-apply migration. The bridge installs before core
 * registers the namespace, so a microtask gives core.apply() the rest of the
 * current stack to finish. A pair of short retries covers Hosts that publish
 * settings asynchronously without creating a permanent polling loop.
 */
